...
trait PredefDatatypeComponent {
  ...
  sealed abstract class PredefDatatype[V](dt: mpi3.lib.MPI_Datatype)
      extends mpi3.SeqDatatype[V] {
    handlePtr.set(dt)
    mpi3.Datatype.register(this)

    override protected[scampi3] lazy val handle = super.handle
  ...
  object MpiChar extends PredefDatatype[Char](mpi3.lib.MPI_CHAR) {
    ...
    def store(p: Pointer[_], idx: Int, elem: Char) {
      require(isValid(elem), mpi3.invalidValueErrorMsg)
  ...
  sealed abstract class Int8(dt: mpi3.lib.MPI_Datatype)
  ...
  object MpiSignedChar extends Int8(mpi3.lib.MPI_SIGNED_CHAR)

  object MpiInt8 extends Int8(mpi3.lib.MPI_INT8_T)

  implicit object MpiByte extends Int8(mpi3.lib.MPI_BYTE)

  sealed abstract class Uint8(dt: mpi3.lib.MPI_Datatype)
  ...
  object MpiUnsignedChar extends Uint8(mpi3.lib.MPI_UNSIGNED_CHAR)

  object MpiUint8 extends Uint8(mpi3.lib.MPI_UINT8_T)

  sealed abstract class Int16(dt: mpi3.lib.MPI_Datatype)
      extends PredefDatatype[Short](dt) {
  ...
  implicit object MpiShort extends Int16(mpi3.lib.MPI_SHORT)

  object MpiInt16 extends Int16(mpi3.lib.MPI_INT16_T)

  sealed abstract class Uint16(dt: mpi3.lib.MPI_Datatype)
  ...
  object MpiUnsignedShort extends Uint16(mpi3.lib.MPI_UNSIGNED_SHORT)

  object MpiUint16 extends Uint16(mpi3.lib.MPI_UINT16_T)

  sealed abstract class Int32(dt: mpi3.lib.MPI_Datatype)
      extends PredefDatatype[Int](dt) {
  ...
  implicit object MpiInt extends Int32(mpi3.lib.MPI_INT)

  object MpiInt32 extends Int32(mpi3.lib.MPI_INT32_T)

  sealed abstract class Uint32(dt: mpi3.lib.MPI_Datatype)
  ...
  object MpiUnsigned extends Uint32(mpi3.lib.MPI_UNSIGNED)

  object MpiUint32 extends Uint32(mpi3.lib.MPI_UINT32_T)

  object MpiLong extends PredefDatatype[Long](mpi3.lib.MPI_LONG) {
  ...
  sealed abstract class Int64(dt: mpi3.lib.MPI_Datatype)
      extends PredefDatatype[Long](dt) {
  ...
  implicit object MpiLongLong extends Int64(mpi3.lib.MPI_LONG_LONG)

  object MpiInt64 extends Int64(mpi3.lib.MPI_INT64_T)

  object MpiUnsignedLong
      extends PredefDatatype[Long](mpi3.lib.MPI_UNSIGNED_LONG) {
    assume(extent.range == AlignHelper.cLongByteSize)
  ...
  sealed abstract class Uint64(dt: mpi3.lib.MPI_Datatype)
      extends PredefDatatype[Long](dt) {
  ...
  object MpiUnsignedLongLong extends Uint64(mpi3.lib.MPI_UNSIGNED_LONG_LONG)

  object MpiUint64 extends Uint64(mpi3.lib.MPI_UINT64_T)

  implicit object MpiFloat extends PredefDatatype[Float](mpi3.lib.MPI_FLOAT) {
  ...
  implicit object MpiDouble extends PredefDatatype[Double](mpi3.lib.MPI_DOUBLE) {
  ...
  object MpiWchar extends PredefDatatype[Int](mpi3.lib.MPI_WCHAR) {
    assume(extent.range == AlignHelper.intByteSize)
  ...
  implicit object MpiBoolean extends PredefDatatype[Boolean](mpi3.lib.MPI_C_BOOL) {
    assume(extent.range == AlignHelper.byteByteSize)
  ...
  sealed abstract class FloatComplex(dt: mpi3.lib.MPI_Datatype)
  ...
  object MpiComplex extends FloatComplex(mpi3.lib.MPI_C_COMPLEX)

  object MpiFloatComplex extends FloatComplex(mpi3.lib.MPI_C_FLOAT_COMPLEX)

  object MpiDoubleComplex
      extends PredefDatatype[(Double, Double)](mpi3.lib.MPI_C_DOUBLE_COMPLEX) {
  ...
  object MpiFloatInt
      extends PredefDatatype[(Float, Int)](mpi3.lib.MPI_FLOAT_INT) {
  ...
  object MpiDoubleInt
      extends PredefDatatype[(Double, Int)](mpi3.lib.MPI_DOUBLE_INT) {
  ...
  object MpiLongInt
      extends PredefDatatype[(Long, Int)](mpi3.lib.MPI_LONG_INT) {
    val alignment = AlignHelper.cLongAlignment
  ...
  object MpiIntInt
      extends PredefDatatype[(Int, Int)](mpi3.lib.MPI_2INT) {
  ...
  object MpiShortInt
      extends PredefDatatype[(Short, Int)](mpi3.lib.MPI_SHORT_INT) {
    val alignment = AlignHelper.shortAlignment
  ...
  //     extends PredefDatatype[mpi3.lib.MPI_Aint](mpi3.lib.MPI_AINT) {
  //   val alignment = mpi3.aintAlignment

  //   def load(p: Pointer[_], idx: Int): mpi3.lib.MPI_Aint =
  //     p.as(classOf[mpi3.lib.MPI_Aint])(idx)

  //   def store(p: Pointer[_], idx: Int, elem: mpi3.lib.MPI_Aint) {
  //     p.as(classOf[mpi3.lib.MPI_Aint])(idx) = elem
  //   }
  // }

  // object MpiOffset
  //     extends PredefDatatype[mpi3.lib.MPI_Offset](mpi3.lib.MPI_OFFSET) {
  //   val alignment = mpi3.offsetAlignment

  //   def load(p: Pointer[_], idx: Int): mpi3.lib.MPI_Offset =
  //     p.as(classOf[mpi3.lib.MPI_Offset])(idx)

  //   def store(p: Pointer[_], idx: Int, elem: mpi3.lib.MPI_Offset) {
  //     p.as(classOf[mpi3.lib.MPI_Offset])(idx) = elem
  //   }
  // }

  object MpiPacked extends mpi3.Datatype[Any] {
    handlePtr.set(mpi3.lib.MPI_PACKED)
    mpi3.Datatype.register(this)
