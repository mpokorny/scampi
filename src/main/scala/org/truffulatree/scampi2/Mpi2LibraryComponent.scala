...
trait Mpi2LibraryComponent {
  ...
  trait Mpi2Library {
    ...
    val MPI_LB: MPI_Datatype
    val MPI_UB: MPI_Datatype
    ...
    val MPI_COMBINER_HINDEXED_INTEGER: Int
    val MPI_COMBINER_HINDEXED: Int
    val MPI_COMBINER_HVECTOR_INTEGER: Int
    ...
    val MPI_COMBINER_STRUCT_INTEGER: Int
