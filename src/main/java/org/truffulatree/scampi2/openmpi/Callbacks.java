...
public class Callbacks {
	...
	public abstract int apply(TypedPointers.MPI_Comm t,
				  int keyval,
				  Pointer<?> extraState,
	...
	public abstract int apply(TypedPointers.MPI_Win t,
				  int keyval,
				  Pointer<?> extraState,
				  Pointer<?> attributeValIn,
				  Pointer<Pointer<?>> attributeValOut,
	...
	public abstract int apply(TypedPointers.MPI_Datatype t,
				  int keyval,
				  Pointer<?> extraState,
				  Pointer<?> attributeValIn,
				  Pointer<Pointer<?>> attributeValOut,
	...
	public abstract void apply(Pointer<TypedPointers.MPI_Comm> t,
	...
	public abstract void apply(Pointer<TypedPointers.MPI_Win> t,
				   Pointer<Integer> errcode);
    };

    public static abstract class MPI_File_errhandler_function
	extends Callback<MPI_File_errhandler_function> {
	public abstract void apply(Pointer<TypedPointers.MPI_File> t,
				   Pointer<Integer> errcode);
    };
	...
	public abstract void apply(Pointer<?> invec,
				   Pointer<?> inoutvec,
				   Pointer<Integer> len,
				   Pointer<TypedPointers.MPI_Datatype> datatype);
    };
	...
	public abstract int apply(Pointer<?> userbuf,
				  TypedPointers.MPI_Datatype datatype,
				  int count,
				  Pointer<?> filebuf,
				  long position,
				  Pointer<?> extraState);
	...
	public abstract int apply(TypedPointers.MPI_Datatype datatype,
